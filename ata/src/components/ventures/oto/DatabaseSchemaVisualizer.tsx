...
export function OtoDatabaseSchemaVisualizer() {
  ...
  const tables = [
    {
      ...
      columns: [
        ...
        { name: 'relationship_type', type: 'VARCHAR(50)' },
    ...
    },
    {
      ...
      columns: [
        ...
        { name: 'reminder_days', type: 'INTEGER' },
      ],
  ...
  const relationships = [
    { from: 'contacts', to: 'interactions', label: '1:N' },
    { from: 'contacts', to: 'events', label: '1:N' },
    { from: 'contacts', to: 'ai_insights', label: '1:N' },
  ];
    ...
    <div className="min-h-screen relative overflow-hidden">
      <div className="relative z-10 p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#717182]">OTO - PostgreSQL + Neo4j (Graph)</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="glass-light glass-hover rounded-2xl p-6">
            <div className="text-2xl text-white mb-1">2.8K</div>
            <div className="text-sm text-[#717182]">Avg Contacts/User</div>
          </div>
          <div className="glass-light glass-hover rounded-2xl p-6">
            <div className="text-2xl text-white mb-1">42M</div>
            <div className="text-sm text-[#717182]">AI Insights Generated</div>
          </div>
        </div>
      </div>
    </div>
