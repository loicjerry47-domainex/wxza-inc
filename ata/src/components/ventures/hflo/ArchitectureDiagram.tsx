...
import { Server, Database, Sun, Sparkles, Cloud, Flower2, Activity } from 'lucide-react';

export function HfloArchitectureDiagram() {
  const components = [
    {
      id: 'hologram-unit',
      name: 'Hologram Unit',
      description: 'Pepper Ghost display',
      icon: Flower2,
  ...
  const connections = [
    { from: 'hologram-unit', to: 'cloud-sync' },
    { from: 'hologram-unit', to: 'solar-panel' },
    { from: 'hologram-unit', to: 'controller' },
    { from: 'controller', to: 'species-library' },
    { from: 'controller', to: 'postgres' },
    { from: 'cloud-sync', to: 'api-server' },
    ...
    <div className="min-h-screen relative overflow-hidden">
      <div className="relative z-10 p-8">
        <div className="mb-8">
          ...
          <p className="text-[#717182]">HFLO - Self-Powered Holographic Display System</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-light glass-hover rounded-2xl p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-white">Quantum Dot Solar</h3>
            </div>
            <p className="text-sm text-[#717182]">30% efficiency. Powers hologram 24/7. No external power needed.</p>
          </div>
          ...
          <div className="glass-light glass-hover rounded-2xl p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-white">Pepper's Ghost</h3>
            </div>
            <p className="text-sm text-[#717182]">4K holographic display. 60fps animations. Lifelike 3D flowers.</p>
          </div>
          ...
          <div className="glass-light glass-hover rounded-2xl p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-white">Species Library</h3>
            </div>
            <p className="text-sm text-[#717182]">1,247 flower species. Seasonal animations. OTA updates.</p>
          </div>
        </div>
      </div>
    </div>
