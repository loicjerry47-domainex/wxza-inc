...
export function PROSFinancialProjections() {
  const revenueData = [
    { year: 'Year 1', revenue: 12, costs: 8, profit: 4 },
    { year: 'Year 2', revenue: 45, costs: 22, profit: 23 },
    { year: 'Year 3', revenue: 125, costs: 48, profit: 77 },
    { year: 'Year 4', revenue: 280, costs: 85, profit: 195 },
    { year: 'Year 5', revenue: 520, costs: 145, profit: 375 },
  ];

  const customerGrowth = [
    { year: 'Year 1', customers: 2400 },
    { year: 'Year 2', customers: 8900 },
    { year: 'Year 3', customers: 24500 },
    { year: 'Year 4', customers: 55000 },
    { year: 'Year 5', customers: 102000 },
  ];

  const metrics = [
    { label: 'Year 3 Revenue', value: '$125M', icon: DollarSign, color: 'from-green-500 to-emerald-500' },
    { label: 'Gross Margin', value: '62%', icon: TrendingUp, color: 'from-blue-500 to-cyan-500' },
    { label: 'Active Projects', value: '24,500', icon: Users, color: 'from-purple-500 to-pink-500' },
    { label: 'Market Share', value: '4.2%', icon: Target, color: 'from-yellow-500 to-amber-500' },
  ];
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      <div className="relative z-10 p-8">
        ...
        {/* Customer Growth */}
        <div className="glass-light liquid-border rounded-2xl p-6 mb-8">
          <h3 className="text-white mb-6">Project Growth</h3>
          ...
          <div className="glass-light liquid-border rounded-2xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-blue-500 to-cyan-500" style={{ width: '30%' }} />
                </div>
              </div>
              <div>
                <div className="flex justify-between mb-2">
          ...
          <div className="glass-light liquid-border rounded-2xl p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2">
                ...
                <span className="text-gray-300">Average project value: $5,100</span>
              </div>
              <div className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2" />
                <span className="text-gray-300">Platform commission: 18%</span>
              </div>
              <div className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2" />
                <span className="text-gray-300">Annual churn rate: 12%</span>
              </div>
              <div className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2" />
                <span className="text-gray-300">Customer acquisition cost: $150</span>
              </div>
              <div className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2" />
                <span className="text-gray-300">Lifetime value: $8,900</span>
              </div>
            </div>
          </div>
        </div>
