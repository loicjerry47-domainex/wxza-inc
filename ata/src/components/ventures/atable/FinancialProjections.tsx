...
export function AtableFinancialProjections() {
  const revenueData = [
    { year: 'Year 1', revenue: 45, costs: 28, profit: 17 },
    { year: 'Year 2', revenue: 120, costs: 58, profit: 62 },
    { year: 'Year 3', revenue: 310, costs: 98, profit: 212 },
    { year: 'Year 4', revenue: 580, costs: 145, profit: 435 },
    { year: 'Year 5', revenue: 920, costs: 205, profit: 715 },
  ];

  const customerGrowth = [
    { year: 'Year 1', customers: 850 },
    { year: 'Year 2', customers: 2400 },
    { year: 'Year 3', customers: 6200 },
    { year: 'Year 4', customers: 11500 },
    { year: 'Year 5', customers: 18000 },
  ];

  const metrics = [
    { label: 'Year 3 Revenue', value: '$310M', icon: DollarSign, color: 'from-green-500 to-emerald-500' },
    { label: 'Gross Margin', value: '68%', icon: TrendingUp, color: 'from-blue-500 to-cyan-500' },
    { label: 'Enterprise Customers', value: '6,200', icon: Users, color: 'from-purple-500 to-pink-500' },
    { label: 'Market Share', value: '12%', icon: Target, color: 'from-yellow-500 to-amber-500' },
  ];
      ...
      <div className="relative z-10 p-8">
        ...
        <div className="glass-light rounded-2xl p-6 mb-8">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={customerGrowth}>
              ...
              />
              <Line type="monotone" dataKey="customers" stroke="#8b5cf6" strokeWidth={3} dot={{ r: 6, fill: '#8b5cf6' }} />
            </LineChart>
          </ResponsiveContainer>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-light rounded-2xl p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-[#717182] text-sm">ARPU (Annual)</span>
              ...
              <div className="flex justify-between">
                <span className="text-[#717182] text-sm">LTV</span>
          ...
          <div className="glass-light rounded-2xl p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-[#717182] text-sm">Starter (1-50 endpoints)</span>
                <span className="text-white">$5K/yr</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#717182] text-sm">Pro (51-500)</span>
                <span className="text-white">$25K/yr</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#717182] text-sm">Enterprise (500+)</span>
                <span className="text-white">$100K+/yr</span>
              </div>
            </div>
          </div>
          ...
          <div className="glass-light rounded-2xl p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="text-white">$25B</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#717182] text-sm">SAM</span>
                <span className="text-white">$8B</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#717182] text-sm">SOM (Year 3)</span>
                <span className="text-white">$960M</span>
              </div>
              <div className="flex justify-between border-t border-white/10 pt-3">
